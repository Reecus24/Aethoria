...
import { TrendingUp, Trophy, Scroll } from 'lucide-react';
...
const EmptyLeaderboard = () => (
  ...
  >
    ...
    >
      <Scroll size={28} style={{ color: 'var(--aeth-gold)' }} />
    </div>
    <h3
    ...
    >
      Sei der Erste, der seinen Namen in die Annalen von Aethoria einträgt!
      Beginne deine Legende und erklimme die Rangliste.
    </p>
  </motion.div>
);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p style={{ color: 'var(--aeth-parchment-dim)', fontFamily: "'IBM Plex Sans', sans-serif" }}>
            Die mächtigsten Abenteurer in ganz Aethoria
          </p>
        </motion.div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  ...
                  >
                    {['Rang', 'Abenteurer', 'Titel', 'Tage', 'Level', 'Wachstum'].map((h) => (
                      <th
                        key={h}
        ...
        >
          * Ranglistenaktualisierung stündlich &middot; Wachstum % basiert auf den letzten 30 Tagen
        </p>
      </div>
    </section>
  );
