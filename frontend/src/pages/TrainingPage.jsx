...
export const TrainingPage = () => {
  ...
  const startTraining = async (stat) => {
    if (gameState.resources.energy < 10) {
      toast.error('Nicht genug Energie (benötigt: 10)', { icon: '⚡' });
      return;
    }
    ...
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p style={{ color: 'var(--aeth-parchment-dim)', fontFamily: "'IBM Plex Sans', sans-serif" }}>
          Trainiere deine Stats, um mächtiger zu werden • Kosten: 10 Energie • Dauer: 5 Minuten
        </p>
      </div>
        ...
        {STATS.map((stat, i) => (
          ...
          >
            ...
            <button
              ...
              disabled={training || activeTraining || gameState.resources.energy < 10 || !gameState.status.can_act}
            ...
            >
              {activeTraining ? 'Training läuft...' : 'Trainieren (10 Energie, 5 Min)'}
            </button>
          </motion.div>
        ))}
      </div>
